...
namespace QAutomation.Core.Services.Logging
{
    public static class LoggerExtensions
    {
        ...
        public static IEnumerable<LogRecordDomainModel> GetLogByIds(ILogger logger, long[] logIds)
        {
        ...
        {
            logger.GetAllLogRecords().ForEachItem(logRecord => logger.DeleteLogRecord(logRecord.Id));
        }
